...
class PropertyStatusSheet implements FromCollection, WithHeadings, ShouldAutoSize, WithTitle, WithStyles, WithEvents
{
    ...
    public function collection()
    {
        return collect([
            ...
            ['Sold', Lot::whereIn('status', ['sold', 'occupied'])->count()],
        ]);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Property Status Distribution');
