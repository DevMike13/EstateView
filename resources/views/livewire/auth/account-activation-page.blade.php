<div class="w-full h-full flex flex-row">
    <div class="w-[40%] h-screen flex flex-col justify-center items-center gap-5">
        <h1 class="text-4xl font-medium">Set a password</h1>
        <p>Almost done. Enter password of your choice and you're all set.</p>
        <form wire:submit.prevent="setPassword" class="w-full flex flex-col justify-center items-center mt-2">
