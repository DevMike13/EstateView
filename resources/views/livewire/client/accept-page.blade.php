<div class="h-screen w-full flex flex-col items-center justify-center p-6 rounded-lg max-w-sm mx-auto">
    <!-- Icon on top -->
    @if ($appointmentStatus === 'accepted' || $appointmentStatus === 'rejected')
    ...
    @if ($appointmentStatus === 'accepted' || $appointmentStatus === 'rejected')
        ...
        <h1 class="text-2xl font-semibold text-gray-700 mb-2 text-center">Appointment Status Unavailable</h1>
    ...
    @else
        <!-- Appointment Accepted Message -->
        <h1 class="text-2xl font-semibold text-green-700 mb-2 text-center">Appointment Accepted</h1>
