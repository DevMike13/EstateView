{{-- <div class="pt-32 max-w-screen min-h-screen overflow-hidden  ">
    <p class="md:text-4xl text-3xl font-semibold text-center text-[#2B2B31] dark:text-white">Contact Us</p>
    <section>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1299.6211033300585!2d121.61286644140161!3d13.931257747901755!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bd4b786f49ea95%3A0xadde652a25f7d09!2sDato%20Law%20Offices!5e0!3m2!1sen!2sph!4v1733286490995!5m2!1sen!2sph" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="max-w-lg ms-auto mt-8 mr-32 rounded-md transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-gray-300"></iframe>
        <div class="max-w-6xl mx-auto p-16 -mt-72">
           <address class="ml-24">
                <div class="-mb-40">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#6b7280" class="size-6 text-gray-500 ">
                        <path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z" />
                        <path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625a1.875 1.875 0 0 1-1.875-1.875v-6.198a2.29 2.29 0 0 0 .091-.086L12 5.432Z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#6b7280" class="size-6 mt-12">
                        <path fill-rule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clip-rule="evenodd" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#6b7280" class="size-6 mt-10">
                ...
                <div class=" ml-16 -mt-6"> 
                    ...
                    <p class="text-gray-400 dark:text-gray-300 text-sm font-medium leading-5 mb-5">
                        Guinto, cor Enriquez St, Lucena City, Quezon
                    </p>
                    <h2 class="text-lg  font-medium dark:text-white">
                        Contact No:
                    </h2>
                    ...
                    <p class="text-gray-400 dark:text-gray-300 text-sm font-medium leading-5 ">
                        lawschedulerr@gmail.com
                    </p>
                </div>
           </address>
        </div>
...
<section class=" dark:bg-slate-800" id="contact">
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4 md:mt-10 -mt-16">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                <h2
                    class="font-heading mb-4 font-bold tracking-tight text-[#2B2B31] dark:text-white text-3xl sm:text-5xl">
                    Get in Touch
                </h2>
                <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">We are always ready to support you.
                </p>
            </div>
        </div>
                ...
                <div class="h-full pr-6">
                    ...
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-6">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white mt-3">Our Address
                                </h3>
                                <p class="text-gray-600 dark:text-slate-400 ">Guinto, cor Enriquez St, Lucena City, Quezon</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded text-gray-50">
                            ...
                            <div class="ml-4 mb-5 mt-2">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Contact
                                </h3>
                                <p class="text-gray-600 dark:text-slate-400">Phone: +639 123456789</p>
                                <p class="text-gray-600 dark:text-slate-400">Email: lawschedulerr@gmail.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded text-gray-50">
                            ...
                            <div class="ml-4 mb-4 mt-2">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Working
                                    hours</h3>
                                <p class="text-gray-600 dark:text-slate-400">Monday - Friday: 09:00 - 18:00</p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="card h-fit max-w-6xl px-0 md:px-12  md:py-4" id="form">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3872.4576924936723!2d121.61042577360793!3d13.931331793114571!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bd4b786f49ea95%3A0xadde652a25f7d09!2sDato%20Law%20Offices!5e0!3m2!1sen!2sph!4v1733319422052!5m2!1sen!2sph" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded-md shadow-sm transition-shadow duration-300 cursor-pointer hover:shadow-md hover:shadow-gray-400"></iframe>
                </div>
