<footer class="bg-gray-900 text-white">
  <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-20">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
      <div>
        <div class="flex items-center gap-3 mb-6">
          <img src="{{ asset('images/logo-white.png') }}" alt="Estate View" class="h-10 brightness-0 invert">
        </div>
        <p class="text-gray-400 leading-relaxed">Your trusted partner in finding your dream home at Manhattan Residences Candelaria.</p>
      </div>
      <div>
      ...
      <div>
        <h3 class="text-sm tracking-wide uppercase mb-6 font-normal">Contact</h3>
    ...
    <div class="border-t border-gray-800 pt-8 text-center text-sm text-gray-500">© 2026 EstateView by DGA Realty Corporation. All rights reserved.</div>
  </div>
</footer>