<div>
  <div class="max-w-5xl lg:px-10 pt-28 mx-auto md:mr-11 md:mt-2 -mt-16 md:text-left text-center mb-32 md:mb-0 flex items-center">
    <div class="flex flex-col gap-y-3">
      <p class="text-sm text-[#2563EB]">LEGAL SERVICES</p>
      <h2 class="text-1xl md:text-3xl lg:text-4xl md:max-w-lg font-bold text-zinc-800">Book appointment with us</h2>
      <p class="md:max-w-lg text-sm md:text-lg">Explore our range of legal services tailored to your needs, designed to help you achieve your desired legal outcomes.</p>
    </div>
</div>
    <div class="flex md:flex-row flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-neutral-800 w-full gap-5 -mt-36 md:-mb-28 mb-0">
        
        <!-- First Card -->
        <div class="flex flex-row bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-gray-300 w-64 h-60">
            <div class="p-4 md:p-5 flex flex-col h-full shadow-none">
              <h3 class="text-1xl font-bold text-gray-800 dark:text-white">
                Consultation/Opinion
              </h3>
              <ul class="list-none text-base ml-1 mt-2">
                <li class=" text-gray-500 dark:text-neutral-400">                
                  Written Type
                </li>
                <li class=" text-gray-500 dark:text-neutral-400">
                  Oral Type
              ...
              <a class="text-sm mt-auto inline-flex items-center gap-x-1 font-semibold rounded-lg border border-transparent text-gray-600 decoration-2 hover:text-[#d6b685] hover:underline focus:underline focus:outline-none focus:text-[#d6b685] disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-600 dark:focus:text-blue-600" href="{{ route('client.booking') }}">
                Get Appointment
        ...
        <div class="flex flex-row bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-gray-300 w-64 h-60">
            <div class="p-4 md:p-5 flex flex-col h-full shadow-none">
              ...
              <ul class="list-none text-base ml-1 mt-2">
                ...
                <li class=" text-gray-500 dark:text-neutral-400">
                  Simple Affidavit/Joint Affidavit
                </li>
              </ul>
              <a class="text-sm mt-auto inline-flex items-center gap-x-1 font-semibold rounded-lg border border-transparent text-gray-600 decoration-2 hover:text-[#d6b685] hover:underline focus:underline focus:outline-none focus:text-[#d6b685] disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-600 dark:focus:text-blue-600" href="{{ route('client.booking') }}">
                Get Appointment
